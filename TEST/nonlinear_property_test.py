# -*- python -*-
# $RCSfile: nonlinear_property_test.py,v $
# $Revision: 1.19 $
# $Author: langer $
# $Date: 2011/02/03 20:18:52 $
...
def run_tests():
    ...
    # test_set = [NonlinearPropertyTest("LargeStrain")]
    # test_set = [NonlinearPropertyTest("NonlinearHeatConductivity")]
    # test_set = [RotatingSquare("QuasiStatic")]
