...
## This test occasionally fails around line 122 when run with --sync
## on Macs.  The error message is "Xlib: unexpected async reply",
## which probably indicates that the wrong thread is making gtk calls.
## All efforts to track down the bug have failed so far.  The error
## occurs while building the menu for the graphics windows, but adding
## code that changes the order in which things occur seems to indicate
## that that's just coincidental.

## Update (March 2010): the test has been rerecorded, so the line
## number reported above is wrong.  Also, the "unexpected async reply"
## problem has probably been fixed.
...
findWidget('Dialog-Load Image').resize(301, 152)
checkpoint meshable button set
checkpoint microstructure page sensitized
...
checkpoint toplevel widget mapped Dialog-New Display Method for Image cyallow.png
findWidget('Dialog-New Display Method for Image cyallow.png').resize(197, 80)
findWidget('Dialog-New Display Method for Image cyallow.png:gtk-ok').clicked()
findWidget('OOF2 Graphics Layer Editor').resize(600, 250)
checkpoint layer editor updated
...
findWidget('OOF2 Graphics 1:Pane0').set_position(283)
findWidget('OOF2 Graphics Layer Editor').resize(600, 250)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 3.9500000000000e+00)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 7.9000000000000e+00)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 1.1850000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 1.5800000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 1.9750000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 2.3700000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 3.1600000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 3.5550000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList').get_selection().select_path((10,))
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 3.5000000000000e+01)
