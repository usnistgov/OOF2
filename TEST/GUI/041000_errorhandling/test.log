...
findWidget('Dialog-Script:filename').set_text('TEST_DATA/')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/e')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/er')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/err')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/erro')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/error')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/errorc')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/errorcm')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/errorcmd')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/errorcmd.')
findWidget('Dialog-Script:filename').set_text('TEST_DATA/errorcmd.p')
