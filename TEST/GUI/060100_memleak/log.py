...
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:entry').set_text('0.')
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:entry').set_text('0.5')
widget_0=findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:entry')
if widget_0: wevent(widget_0, Gdk.EventType.FOCUS_CHANGE, in_=0, window=widget_0.get_window())
del widget_0
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 7.3825503355705e-01)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 1.2080536912752e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 2.3489932885906e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 2.9530201342282e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.3557046979866e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.4899328859060e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.6912751677852e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.7583892617450e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.8255033557047e+00)
wevent(findWidget('Dialog-New:what:Microstructure'), Gdk.EventType.BUTTON_PRESS, button=1, state=0, window=findWidget('Dialog-New:what:Microstructure').get_window())
...
checkpoint toplevel widget mapped chooserPopup-Microstructure
findWidget('chooserPopup-Microstructure').deactivate() # MenuLogger
wevent(findWidget('Dialog-New:what:Skeleton'), Gdk.EventType.BUTTON_PRESS, button=1, state=0, window=findWidget('Dialog-New:what:Skeleton').get_window())
...
wevent(findWidget('Dialog-New:what:Mesh'), Gdk.EventType.BUTTON_PRESS, button=1, state=0, window=findWidget('Dialog-New:what:Mesh').get_window())
...
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:slider').get_adjustment().set_value( 4.7286821705426e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:slider').get_adjustment().set_value( 4.0310077519380e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:slider').get_adjustment().set_value( 3.5658914728682e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:slider').get_adjustment().set_value( 2.4031007751938e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:slider').get_adjustment().set_value( 1.7829457364341e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:gray:slider').get_adjustment().set_value( 0.0000000000000e+00)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 9.8449612403101e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 9.3023255813953e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 7.9069767441860e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 7.0542635658915e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 5.8914728682171e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 5.0387596899225e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.8837209302326e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.8062015503876e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.7286821705426e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.5736434108527e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.2635658914729e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.0310077519380e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 3.7209302325581e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 3.6434108527132e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 3.5658914728682e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 3.4883720930233e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 3.1782945736434e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 2.9457364341085e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 2.6356589147287e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 2.5581395348837e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 2.4806201550388e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 2.4031007751938e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 2.4806201550388e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 3.4883720930233e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 4.0310077519380e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 5.7364341085271e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 7.2868217054264e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 9.3798449612403e-01)
findWidget('Dialog-New:how:Element Edges:color:TranslucentGray:alpha:slider').get_adjustment().set_value( 1.0000000000000e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.6912751677852e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.3557046979866e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 3.1543624161074e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 2.4832214765101e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 1.8120805369128e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 1.4765100671141e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 1.0067114093960e+00)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 9.3959731543624e-01)
findWidget('Dialog-New:how:Element Edges:width:slider').get_adjustment().set_value( 8.7248322147651e-01)
findWidget('Dialog-New:widget_GTK_RESPONSE_OK').clicked()
