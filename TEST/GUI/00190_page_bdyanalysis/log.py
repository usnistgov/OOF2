...
# setComboBox(findWidget('Dialog-Initialize field Temperature:initializer:Chooser'), 'XYTFunction')
...
setComboBox(findWidget('OOF2:Navigation:PageMenu'), 'Boundary Conditions')
checkpoint page installed Boundary Conditions
findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll').get_hadjustment().set_value( 2.8285714285714e+00)
findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll').get_hadjustment().set_value( 3.6771428571429e+01)
findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll').get_hadjustment().set_value( 5.9400000000000e+01)
findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll').get_hadjustment().set_value( 9.9000000000000e+01)
...
findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll:BCList').get_selection().select_path((1,))
tree=findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll:BCList')
column = tree.get_column(1)
tree.row_activated((1,), column)
checkpoint toplevel widget mapped Dialog-Edit Boundary Condition
