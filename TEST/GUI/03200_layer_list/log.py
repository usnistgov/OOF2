...
# This test appears to fail if a screen saver is running, at least on
# some Linux systems.  The screen saver apparently suppresses pop-up
# menus.  This isn't a bug in OOF2.
