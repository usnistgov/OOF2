...
setComboBox(findWidget('Dialog-Create a new subproblem:subproblem:PixelGroup:group'), '#f800f8')
...
setComboBox(findWidget('Dialog-Edit Subproblem definition:subproblem:PixelGroup:group'), '#f800f8')
