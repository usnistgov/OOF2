...
findWidget('Adaptive Mesh Refinement:Next').clicked()
findWidget('Adaptive Mesh Refinement:Next').clicked()
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 1.1000000000000e+01)
findWidget('Adaptive Mesh Refinement:Next').clicked()
setComboBox(findWidget('OOF2:Navigation:PageMenu'), 'Solver')
checkpoint Solver page sensitized
checkpoint page installed Solver
findWidget('OOF2').resize(562, 484)
...
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.6000000000000e+01)
...
widget_0.event(event(gtk.gdk.BUTTON_PRESS,x= 1.1000000000000e+01,y= 3.6000000000000e+01,button=1,state=0,window=widget_0.window))
...
findWidget('OOF2:Skeleton Page:Pane').set_position(181)
...
findWidget('OOF2').resize(705, 625)
findWidget('OOF2:Skeleton Page:Pane').set_position(134)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 3.5777433423322e+01)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 7.1554866846645e+01)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 1.0733230026997e+02)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 1.4310973369329e+02)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 1.6100000000000e+02)
...
widget_2.event(event(gtk.gdk.BUTTON_PRESS,x= 8.0000000000000e+00,y= 3.6000000000000e+01,button=1,state=0,window=widget_2.window))
findCellRenderer(findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList'), col=0, rend=0).emit('toggled', '11')
findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList').get_selection().select_path((11,))
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 4.6000000000000e+01)
checkpoint contourmap info updated for Graphics_1
...
widget_3.event(event(gtk.gdk.BUTTON_PRESS,x= 1.1000000000000e+01,y= 8.0000000000000e+00,button=1,state=0,window=widget_3.window))
findCellRenderer(findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList'), col=0, rend=0).emit('toggled', '10')
findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList').get_selection().select_path((10,))
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 4.0000000000000e+01)
checkpoint contourmap info updated for Graphics_1
...
widget_4.event(event(gtk.gdk.BUTTON_PRESS,x= 1.1000000000000e+01,y= 3.0000000000000e+01,button=1,state=0,window=widget_4.window))
findCellRenderer(findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList'), col=0, rend=0).emit('toggled', '11')
findWidget('OOF2 Graphics 1:Pane0:LayerScroll:LayerList').get_selection().select_path((11,))
findWidget('OOF2 Graphics 1:Pane0:LayerScroll').get_vadjustment().set_value( 4.6000000000000e+01)
checkpoint contourmap info updated for Graphics_1
...
checkpoint mesh page sensitized
checkpoint OOF.Mesh.Modify
findWidget('Adaptive Mesh Refinement:Close').clicked()
findMenu(findWidget('OOF2:MenuBar'), 'File:Save:Python_Log').activate()
checkpoint toplevel widget mapped Dialog-Python_Log
findWidget('Dialog-Python_Log').resize(191, 98)
findWidget('Dialog-Python_Log:filename').set_text('a')
findWidget('Dialog-Python_Log:filename').set_text('am')
findWidget('Dialog-Python_Log:filename').set_text('amr')
findWidget('Dialog-Python_Log:filename').set_text('amr.')
findWidget('Dialog-Python_Log:filename').set_text('amr.l')
findWidget('Dialog-Python_Log:filename').set_text('amr.lo')
findWidget('Dialog-Python_Log:filename').set_text('amr.log')
