...
def sensitization0():
    return (sensitizationCheck({'New': 0,
            ...
            and
            historySensitizationCheck('Element', prev=0, ok=0, next=0)
            and
...
def sensitization6():
    return (sensitizationCheck({'New': 1,
                               ...
                               base="OOF2:Skeleton Selection Page:Pane:Groups")
            and
            historySensitizationCheck('Element', prev=1, ok=1, next=0)
            and
            sensitizationCheck({'Undo' : 1,
                                'Redo' : 0,
                                'Clear': 1,
...
def elementSelectionCheck(elements):
    return skeletonElementSelectionCheck('microstructure:skeleton', elements)
