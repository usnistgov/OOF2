...
assert tests.chooserCheck(elbox+":SegmentList",["Segment 135, nodes (36, 44) (length: 15.4029218007)","Segment 134, nodes (36, 37) (length: 15.5)","Segment 70, nodes (37, 45) (length: 12.5)","Segment 128, nodes (44, 45) (length: 6.5)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 36 at (22.0, 50.0) (angle: 54.2461127456)","Node 37 at (37.5, 50.0) (angle: 90)","Node 45 at (37.5, 62.5) (angle: 90)","Node 44 at (31.0, 62.5) (angle: 125.753887254)"], tolerance=1.e-6)
...
assert tests.chooserCheck(elbox+":SegmentList",["Segment 68, nodes (36, 43) (length: 15.7003184681)", "Segment 135, nodes (36, 44) (length: 15.4029218007)", "Segment 130, nodes (43, 44) (length: 18.5)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 36 at (22.0, 50.0) (angle: 72.988721236)","Node 44 at (31.0, 62.5) (angle: 54.2461127456)", "Node 43 at (12.5, 62.5) (angle: 52.7651660184)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiFloatCompare({'X Text':23.53,'Y Text':60.59},cbox)
assert tests.gtkMultiTextCompare({'Boundary':'','Group':'','Mobility':'free','Position':'(31.0, 62.5)','Index':'44'},ndbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
...
assert tests.chooserCheck(sgbox+":NodeList",["Node 36 at (22.0, 50.0)","Node 43 at (12.5, 62.5)"], tolerance=1.e-6)
...
assert tests.chooserCheck(sgbox+":NodeList",["Node 43 at (12.5, 62.5)","Node 44 at (31.0, 62.5)"], tolerance=1.e-6)
...
assert tests.chooserCheck(sgbox+":NodeList",["Node 43 at (12.5, 62.5)","Node 52 at (12.5, 75.0)"], tolerance=1.e-6)
...
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(elbox+":SegmentList",["Segment 79, nodes (43, 52) (length: 12.5)","Segment 130, nodes (43, 44) (length: 18.5)","Segment 127, nodes (44, 53) (length: 15.4029218007)","Segment 131, nodes (52, 53) (length: 27.5)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 43 at (12.5, 62.5) (angle: 90)","Node 44 at (31.0, 62.5) (angle: 125.753887254)","Node 53 at (40.0, 75.0) (angle: 54.2461127456)","Node 52 at (12.5, 75.0) (angle: 90)"], tolerance=1.e-6)
...
assert tests.sensitizationCheck({'Prev':False,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(elbox+":SegmentList",["Segment 135, nodes (36, 44) (length: 15.4029218)", "Segment 134, nodes (36, 37) (length: 15.5)", "Segment 70, nodes (37, 45) (length: 12.5)", "Segment 128, nodes (44, 45) (length: 6.5)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 36 at (22.0, 50.0) (angle: 54.2461127)","Node 37 at (37.5, 50.0) (angle: 90)","Node 45 at (37.5, 62.5) (angle: 90)","Node 44 at (31.0, 62.5) (angle: 125.753887)"], tolerance=1.e-6)
...
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(elbox+":SegmentList",["Segment 118, nodes (53, 61) (length: 12.747549)","Segment 119, nodes (53, 62) (length: 18.027756)","Segment 109, nodes (61, 62) (length: 12.747549)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 53 at (40.0, 75.0) (angle: 45.0)","Node 62 at (50.0, 90.0) (angle: 45.0)","Node 61 at (37.5, 87.5) (angle: 90)"], tolerance=1.e-6)
...
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(elbox+":SegmentList",["Segment 110, nodes (62, 70) (length: 10)","Segment 120, nodes (62, 71) (length: 16.0078106)","Segment 121, nodes (70, 71) (length: 12.5)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 62 at (50.0, 90.0) (angle: 51.340191)","Node 71 at (62.5, 100.0) (angle: 38.659808)","Node 70 at (50.0, 100.0) (angle: 90)"], tolerance=1.e-6)
...
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(elbox+":SegmentList",["Segment 81, nodes (46, 53) (length: 16.007811)","Segment 74, nodes (46, 47) (length: 16)","Segment 82, nodes (47, 54) (length: 7.3824115)","Segment 83, nodes (53, 54) (length: 23.286262)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 46 at (50.0, 62.5) (angle: 128.659808)","Node 47 at (66.0, 62.5) (angle: 61.69924423)","Node 54 at (62.5, 69.0) (angle: 133.232172)","Node 53 at (40.0, 75.0) (angle: 36.408775)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiFloatCompare({'X Text':58.82,'Y Text':65.59},cbox)
assert tests.gtkMultiTextCompare({'Boundary':'','Group':'ndset','Mobility':'free','Position':'(62.5, 69.0)','Index':'54'},ndbox)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
...
assert findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiFloatCompare({'X Text':73.24,'Y Text':47.35},cbox)
assert tests.gtkMultiTextCompare({'Boundary':'','Groups':'','Index':'137','Length':'14.401976728695566'},sgbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(sgbox+":ElementList",["Element 62","Element 63"])
assert tests.chooserCheck(sgbox+":NodeList",["Node 33 at (78.198140, 37.0)","Node 39 at (72.0, 50.0)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Node").get_active()
assert findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiTextCompare({'X Text':'42.65','Y Text':'97.65'},cbox,tolerance=1.e-6)
assert tests.gtkMultiTextCompare({'Boundary':'top','Groups':'segmentgroup','Index':'111','Length':'12.5'},sgbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(sgbox+":ElementList",["Element 41"])
assert tests.chooserCheck(sgbox+":NodeList",["Node 69 at (37.5, 100.0)","Node 70 at (50.0, 100.0)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Node").get_active()
assert findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiTextCompare({'X Text':'8.235','Y Text':'97.65'},cbox, tolerance=1.e-6)
assert tests.gtkMultiTextCompare({'Boundary':'top','Groups':'','Index':'102','Length':'12.5'},sgbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(sgbox+":ElementList",["Element 38"])
assert tests.chooserCheck(sgbox+":NodeList",["Node 66 at (0.0, 100.0)","Node 67 at (12.5, 100.0)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Node").get_active()
assert findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiTextCompare({'X Text':'53.24','Y Text':'1.765'},cbox,tolerance=1.e-6)
...
assert tests.chooserCheck(sgbox+":NodeList",["Node 4 at (50.0, 0.0)","Node 5 at (62.5, 0.0)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Node").get_active()
assert findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiTextCompare({'X Text':'47.06','Y Text':'82.35'},cbox,tolerance=1.e-6)
assert tests.gtkMultiTextCompare({'Boundary':'','Groups':'segmentgroup','Index':'119','Length':'18.027756377319946'},sgbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(sgbox+":ElementList",["Element 45","Element 49"])
assert tests.chooserCheck(sgbox+":NodeList",["Node 53 at (40.0, 75.0)","Node 62 at (50.0, 90.0)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Node").get_active()
assert findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiTextCompare({'X Text':'62.94','Y Text':'87.06'},cbox,tolerance=1.e-6)
assert tests.gtkMultiTextCompare({'Boundary':'','Groups':'segmentgroup','Index':'123','Length':'25.124689052802225'},sgbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(sgbox+":ElementList",["Element 47","Element 48"])
assert tests.chooserCheck(sgbox+":NodeList",["Node 62 at (50.0, 90.0)","Node 63 at (75.0, 87.5)"], tolerance=1.e-6)
...
assert not findWidget(tbox+":Click:Segment").get_active()
assert tests.gtkMultiTextCompare({'X Text':'53.24','Y Text':'1.765'},cbox,tolerance=1.e-6)
assert tests.gtkMultiTextCompare({'Boundary':'','Group':'','Mobility':'x only','Position':'(50, 0)','Index':'4'},ndbox,tolerance=1.e-6)
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
...
assert tests.sensitizationCheck({'Prev':True,'Clear':True,'Next':False},tbox)
assert tests.chooserCheck(elbox+":SegmentList",["Segment 100, nodes (58, 66) (length: 12.5)","Segment 94, nodes (58, 59) (length: 12.5)","Segment 101, nodes (59, 67) (length: 12.5)","Segment 102, nodes (66, 67) (length: 12.5)"], tolerance=1.e-6)
assert tests.chooserCheck(elbox+":NodeList",["Node 58 at (0.0, 87.5) (angle: 90)","Node 59 at (12.5, 87.5) (angle: 90)","Node 67 at (12.5, 100.0) (angle: 90)","Node 66 at (0.0, 100.0) (angle: 90)"], tolerance=1.e-6)
