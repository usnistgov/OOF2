...
findWidget('OOF2 Graphics 1:Pane0:Pane1').set_position(687)
...
checkpoint selection info updated
checkpoint selection info updated
findWidget('OOF2 Graphics 1:Pane0:Pane1').set_position(713)
...
findWidget('Dialog-New Display Method for Mesh mesh').resize(444, 255)
setComboBox(findWidget('Dialog-New Display Method for Mesh mesh:method:Chooser'), 'Filled Contour')
findWidget('Dialog-New Display Method for Mesh mesh').resize(466, 373)
setComboBox(findWidget('Dialog-New Display Method for Mesh mesh:method:Filled Contour:what:what_0'), 'Flux')
setComboBox(findWidget('Dialog-New Display Method for Mesh mesh:method:Filled Contour:what:Parameters:component'), 'yy')
findWidget('Dialog-New Display Method for Mesh mesh:gtk-ok').clicked()
checkpoint layer editor updated
findWidget('OOF2 Messages 1').resize(580, 200)
...
findWidget('Questioner').resize(362, 91)
