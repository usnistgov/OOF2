...
#findWidget('OOF2:Boundary Conditions Page:Condition:EnableDisable').clicked()
findCellRenderer(findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll:BCList'), col=0, rend=0).emit('toggled', '2')
...
findCellRenderer(findWidget('OOF2:Boundary Conditions Page:Condition:BCScroll:BCList'), col=0, rend=0).emit('toggled', '0')
