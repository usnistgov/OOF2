...
// -----------------------------------------------------------------------
// $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/lang.cxx,v 1.1 2014/06/25 18:41:01 lck Exp $
//
// lang.cxx
//
...
void Language::set_init(const char *iname) {
  set_module(iname,0);
}
...
void Language::create_command(const char *,const char *) {
...
void Language::cpp_open_class(char *classname,const char *classrename, char *ctype, int strip) {
...
void Language::cpp_member_func(char *name,const char *iname, DataType *t, ParmList *l) {
...
void Language::cpp_constructor(char *name,const char *iname, ParmList *l) {
  ...
  if (iname)
    cname = name_construct(const_cast<char*>(iname));
  else
...
void Language::cpp_destructor(char *name,const char *iname) {
...
void Language::cpp_variable(char *name,const char *iname, DataType *t) {
  char *prefix, *cname;
...
void Language::cpp_static_func(char *name,const char *iname, DataType *t, ParmList *l) {
...
void Language::cpp_declare_const(const char *name,const char *iname, DataType *type,const char *value)
{
...
void Language::cpp_static_var(char *name,const char *iname, DataType *t) {
...
void Language::cpp_class_decl(char *, char *,const char *) {
