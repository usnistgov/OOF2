...
/***********************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/latex.cxx,v 1.1 2014/06/25 18:41:07 lck Exp $
 *
 * latex.c
 *
...
LATEX::LATEX() {
  ...
  tag_pagestyle =(char*) "\\pagestyle{headings}";
  tag_parindent =(char*) "0.0in";
  tag_textwidth =(char*) "6.5in";
  tag_documentstyle =(char*) "[11pt]{article}";
  tag_oddsidemargin =(char*) "0.0in";
  tag_title =(char*) "{\\Large \\bf : }";
  tag_preformat = (char*)"{\\small \\begin{verbatim}:\\end{verbatim}}";
  tag_usage =(char*) "{\\tt \\bf : }";
  tag_descrip =(char*) "\\\\\n\\makebox[0.5in]{}\\begin{minipage}[t]{6in}:\n\\end{minipage}\\\\\n";
  tag_text =(char*) ":\\\\";
  tag_cinfo =(char*) "{\\tt : }\\\\";
  tag_section =(char*) "\\section{:}";
  tag_subsection=(char*)"\\subsection{:}";
  tag_subsubsection=(char*)"\\subsubsection{:}";
}
