...
/*******************************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/symbol.cxx,v 1.1 2014/06/25 18:41:26 lck Exp $
 *
 * File : symbol.cxx
 *
...
// -----------------------------------------------------------------------------
// int add_symbol(const char *name, DataType *type, char *value)
// 
...
int add_symbol(const char *name, DataType *type,const char *value) {
...
// -----------------------------------------------------------------------------
// int update_symbol(const char *name, DataType *type, char *value)
//
...
int update_symbol(const char *name, DataType *type,const char *value) {
