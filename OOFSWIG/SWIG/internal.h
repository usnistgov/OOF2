...
/***********************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/internal.h,v 1.1 2014/06/25 18:41:01 lck Exp $
 *
 * internals.h
 *
...
class DocTitle : public DocEntry {
public:
  DocTitle(const char *title, DocEntry *_parent);  // Create a new title
...
public:
  ...
  void        style(const char *name, char *value);
