...
/*******************************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/html.cxx,v 1.1 2014/06/25 18:40:56 lck Exp $
 *
 * File : html.cxx
 *
...
HTML::HTML() {
  ...
  tag_body =(char*) "<BODY BGCOLOR=\"#ffffff\">:</BODY>";
  tag_title = (char*)"<H1>:</H1>";
  tag_contents = (char*)"<HR><H1>:</H1>";
  tag_section =(char*) "<HR><H2>:</H2>";
  tag_subsection =(char*) "<H3>:</H3>";
  tag_subsubsection =(char*) "<H4>:</H4>";
  tag_usage =(char*) "<P><TT><B>:</B></TT>";
  tag_descrip =(char*) "<BLOCKQUOTE>:</BLOCKQUOTE>";
  tag_text =(char*) "<P>";
  tag_cinfo =(char*) "";
  tag_preformat =(char*) "<PRE>:</PRE>";
}
