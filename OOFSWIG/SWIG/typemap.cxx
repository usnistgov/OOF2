...
struct TypeMap {
  ...
  TypeMap(const char *l, DataType *t, String &c, ParmList *p = 0) {
    lang = copy_string(l);
    type = new DataType(t);
    code << c;
    first = type_id;
  ...
  TypeMap(const char *l, DataType *t,const char *c, ParmList *p = 0) {
    lang = copy_string(l);
    type = new DataType(t);
    code << c;
    first = type_id;
...
static char *typemap_string(const char *lang, DataType *type,const char *pname, char *ary, const char *suffix) {
  static String str;
...
void typemap_register(const char *op,const char *lang, DataType *type,const char *pname, 
                      const char *getcode, ParmList *args) {
...
void typemap_register(const char *op,const char *lang, char *type,const char *pname, 
                      char *getcode, ParmList *args) {
  DataType temp;
...
void typemap_register_default(const char *op,const char *lang, int type, int ptr, char *arraystr,
			   char *code, ParmList *args) {
...
TypeMap *typemap_search_array(const char *op,const char *lang, DataType *type,const char *pname, String &str) {
...
static void typemap_locals(DataType *t,const char *pname, String &s, ParmList *l, WrapperFunction &f) {
  Parm *p;
  char *new_name;
...
static const char     *realname = 0;   // Real parameter name

char *typemap_lookup_internal(const char *op,const char *lang, DataType *type,const char *pname,const char *source,
...
char *typemap_check_internal(const char *op,const char *lang, DataType *type,const char *pname) {
  static String str;
  char *key = 0;
  TypeMap *tm = 0;
...
void typemap_clear(const char *op,const char *lang, DataType *type,const char *pname) {
...
void typemap_copy(const char *op,const char *lang, DataType *stype, char *sname,
		      DataType *ttype, char *tname) {
...
static char *fragment_string(const char *op,const char *lang) {
  static String str;
...
void fragment_register(const char *op,const char *lang, char *code) {
...
char *fragment_lookup(const char *op,const char *lang, int age) {
  static String str;
  char *key = 0;
  TypeMap *tm = 0;
...
void fragment_clear(const char *op,const char *lang) {
