...
/*******************************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/comment.cxx,v 1.1 2014/06/25 18:40:49 lck Exp $
 *
 * File : comment.cxx
 *
...
public:  
  ...
  Comment(char *t, int line, int col,const char *f);
  ~Comment();
...
// -----------------------------------------------------------------------
Comment::Comment(char *t, int line, int col, const char *f) {
    int   nlines = 0;
    char *c;
...
// -----------------------------------------------------------------------------
// void CommentHandler::style(const char *name, char *value)
// 
...
static const char *comment_usage = "\
