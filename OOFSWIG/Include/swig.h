 ...
 *******************************************************************************/
/***********************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/Include/swig.h,v 1.1 2014/06/25 18:40:05 lck Exp $
 *
 * swig.h
 *
...
public:
  ...
  virtual void create_function(char *,const char *, DataType *, ParmList *) = 0; 
  virtual void link_variable(char *,const char *, DataType *)  = 0;
  virtual void declare_const(const char *,const char *, DataType *,const char *) = 0;
  virtual void initialize(void) = 0;
  virtual void headers(void) = 0;
  virtual void close(void) = 0;
  virtual void set_module(const char *mod_name,char **mod_list) = 0;
  virtual void set_init(const char *init_name);
  ...
  virtual void create_command(const char *cname,const char *iname);
  ...
  virtual void cpp_member_func(char *name, const char *iname, DataType *t, ParmList *l);
  virtual void cpp_constructor(char *name,const char *iname, ParmList *l);
  virtual void cpp_destructor(char *name,const char *newname);
  virtual void cpp_open_class(char *name, const char *rename, char *ctype, int strip);
  virtual void cpp_close_class();
  virtual void cpp_cleanup();
  virtual void cpp_inherit(char **baseclass, int mode = INHERIT_ALL);
  virtual void cpp_variable(char *name,const char *iname, DataType *t);
  virtual void cpp_static_func(char *name,const char *iname, DataType *t, ParmList *l);
  virtual void cpp_declare_const(const char *name,const char *iname, DataType *type,const char *value);
  virtual void cpp_static_var(char *name,const char *iname, DataType *t);
  ...
  virtual void cpp_class_decl(char *, char *,const char *);
...
public:
  ...
  void style(const char *name,char *value);// Change doc style.
...
extern void cplus_emit_member_func(char *classname, char *classtype, char *classrename,
                                   char *mname,const char *mrename, DataType *type, ParmList *l,
                                   int mode);
...
public:
  ...
  void    print(FILE *f);
  void    print(String &f); 
  void    add_local(const char *type, const char *name, char *defvalue = 0);
...
extern int  add_symbol(const char *, DataType *,const char *);
extern void remove_symbol(char *);
extern int  update_symbol(const char *, DataType *,const char *);
...
extern void    typemap_register(const char *op,const char *lang, DataType *type,const char *pname,const char *code, ParmList *l = 0);
extern void    typemap_register(const char *op,const char *lang, char *type,const char *pname,const char *code,ParmList *l = 0);
extern void    typemap_register_default(const char *op,const char *lang, int type, int ptr,const char *arraystr,const char *code, ParmList *l = 0);
extern char   *typemap_lookup(const char *op,const char *lang, DataType *type,const char *pname,const char *source,const char *target,
                              WrapperFunction *f = 0);
extern void    typemap_clear(const char *op,const char *lang, DataType *type,const char *pname);
extern void    typemap_copy(const char *op,const char *lang, DataType *stype, char *sname, DataType *ttype, char *tname);
extern char   *typemap_check(const char *op,const char *lang, DataType *type,const char *pname);
extern void    typemap_apply(DataType *tm_type, char *tmname, DataType *type,const char *pname);
extern void    typemap_clear_apply(DataType *type,const char *pname);
...
extern void    fragment_register(const char *op,const char *lang, char *code);
extern char   *fragment_lookup(const char *op,const char *lang, int age);
extern void    fragment_clear(const char *op,const char *lang);
...
extern char  *name_wrapper(const char *fname, const char *prefix, int suppress=0);
extern char  *name_member(const char *fname, char *classname, int suppress=0);
extern char  *name_get(char *vname, int suppress=0);
extern char  *name_set(char *vname, int suppress=0);
extern char  *name_construct(const char *classname, int suppress=0);
extern char  *name_destroy(const char *classname, int suppress=0);
