...
class SkelContextEdgeBoundary(SkelContextBoundary):
    ...
    def draw(self, display, canvaslayer, skeleton):  # double dispatch function
        display.drawEdgeBoundary(self, skeleton, canvaslayer)
...
class SkelContextPointBoundary(SkelContextBoundary):
    ...
    def draw(self, display, canvaslayer, skeleton):  # double dispatch function
        display.drawPointBoundary(self, skeleton, canvaslayer)
