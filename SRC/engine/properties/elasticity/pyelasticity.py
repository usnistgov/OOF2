...
# DummyData just checks that the localdata generated by begin_point is
# passed through to the other methods correctly.
class DummyData:
    def __init__(self, x):
        self.x = x
    def __repr__(self):
        return f"DummyData({self.x})"
