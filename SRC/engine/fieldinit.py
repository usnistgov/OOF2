...
## is no Field widget at the moment.
...
registeredclass.Registration(
    ...
    1,
    params=[
    strfunction.XYStrFunctionParameter('fx', value='0.0',
                   tip="The x component of the field as a function "
                                       + funcofstring),
    strfunction.XYStrFunctionParameter('fy', value='0.0',
                   tip="The y component of the field as a function "
                                       + funcofstring),
    strfunction.XYStrFunctionParameter('fz', value='0.0',
