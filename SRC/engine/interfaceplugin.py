...
##            switchboard.requestCallback('changed pixel group', self.changedpixgrp)
        ...
        #TODO: Somehow use a timestamp in the mesh for interfaces (see mesh.py)
...
#         #TODO: Make this more specific (like check if the material
...
##        print "all assigned materials", self.getInterfaceMaterials()
    ...
    #TODO: For a union of interfaces, not necessary to delete the whole
    #union.
...
##                 self._interface2==other._interface1))
    ...
    #whether a skeleton segment is part of the interface.
    def getAdjacentElements(self,seg,skelctxt):
        # TODO: This loop returns the first element-set where it gets
