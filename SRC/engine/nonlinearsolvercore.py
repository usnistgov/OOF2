...
# TODO: all the computations of norm, inner product and residual computations
...
#          raise ooferror2.PyErrConvergenceFailure('NL solver - Conjugate Gradient iterations', maxiter)
