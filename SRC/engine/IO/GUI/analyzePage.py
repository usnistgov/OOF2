...
## TODO: The "Go" button isn't desensitized when the XY function arg
...
## parameters change.  This should be fixed in conjunction with
## combining the Scalar and Aggregate outputs, and combining the bulk
## and boundary analysis pages, as in OOF3D.
