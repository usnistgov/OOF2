...
public:
			  ...
			  "Isoparametric 4 noded quadrilateral with bilinear interpolation for both positions and fields", 4, 1)
  {
    ...
    ProtoNode *pn0 = addProtoNode(MasterCoord(-1.0, -1.0));
    pn0->set_mapping();
    pn0->set_func();
    pn0->set_corner();
    pn0->on_edge(0);
    ...
    ProtoNode *pn1 = addProtoNode(MasterCoord(1.0, -1.0));
    pn1->set_mapping();
    pn1->set_func();
    pn1->set_corner();
    pn1->on_edge(0);
    ...
    ProtoNode *pn2 = addProtoNode(MasterCoord(1.0, 1.0));
    pn2->set_mapping();
    pn2->set_func();
    pn2->set_corner();
    pn2->on_edge(1);
    ...
    ProtoNode *pn3 = addProtoNode(MasterCoord(-1.0, 1.0));
    pn3->set_mapping();
    pn3->set_func();
    pn3->set_corner();
    pn3->on_edge(2);
