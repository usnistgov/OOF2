...
{
  // Called by BrushSelection::start() and BrushSelection::advance()
  // in pixelselectioncourier.C.  Those functions are called by
  // CPixelSelection::select() in cpixelselection.C.
