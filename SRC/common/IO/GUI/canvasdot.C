...
static void gnome_canvas_dot_class_init(GnomeCanvasDotClass *cls);
...
static void
gnome_canvas_dot_class_init (GnomeCanvasDotClass *cls)
{
  ...
  parent_class = (GnomeCanvasItemClass *)g_type_class_peek_parent ((gpointer)cls);
