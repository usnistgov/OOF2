...
static void gnome_canvas_triangle_class_init(GnomeCanvasTriangleClass *cls);
...
static void
gnome_canvas_triangle_class_init (GnomeCanvasTriangleClass *cls)
{
  ...
  item_class = (GnomeCanvasItemClass *) cls;

  parent_class = (GnomeCanvasItemClass *) g_type_class_peek_parent (cls);
